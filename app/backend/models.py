...
class ProductInfo(models.Model):
    shop = models.ForeignKey(Shop, verbose_name='Магазин', related_name='shops', blank=True, on_delete=models.CASCADE)
    name = models.ForeignKey(Products, verbose_name='Заголовок описания продукта',
                              related_name='products_info', blank=True, on_delete=models.CASCADE)
...
class ProductParameter(models.Model):
    ...
    def __str__(self):
        return self.product_info.name.name
