...
from backend.models import Shop, Category, Products, ProductInfo, Contact, ConfirmEmailToken, Parameter, \
    ProductParameter, Order, OrderItem
from backend.serializers import ShopSerializer, CategorySerializer, ProductsSerializer, ProductInfoSerializer, \
        ...
        if url:
            ...
            try:
                ...
                for item in data['goods']:
                    product, _ = Products.objects.get_or_create(name=item['name'], category_id=item['category'])
